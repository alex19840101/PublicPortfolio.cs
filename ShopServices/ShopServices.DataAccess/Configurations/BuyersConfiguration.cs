...
namespace ShopServices.DataAccess.Configurations
{
    internal class BuyersConfiguration : IEntityTypeConfiguration<Buyer>
    {
        ...
        public void Configure(EntityTypeBuilder<Buyer> builder)
        {
            ...
            builder.Property(b => b.Email).HasField("_email").HasMaxLength(MAX_EMAIL_LENGTH).IsRequired();
            ...
            builder.Property(b => b.TelegramChatId).HasField("_telegramChatId");
            builder.Property(b => b.NotificationMethods).HasField("_notificationMethods");
            ...
            builder.Property(b => b.DiscountGroups).HasField("_discountGroups");
            builder.Property(b => b.Blocked).HasField("_blocked");
        }
    }
}
