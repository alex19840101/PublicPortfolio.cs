...
const string SERVICE_NAME = "Buyers.API";
...
try
{
    ...
    builder.Services.AddScoped<IBuyersService>(src => new BuyersService(
    ...
    string dataBaseConnectionStr = builder.Configuration.GetConnectionString("ShopServicesBuyers")!;
