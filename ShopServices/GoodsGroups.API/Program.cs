...
const string SERVICE_NAME = "GoodsGroups.API";
...
try
{
    ...
    builder.Services.AddScoped<IGoodsGroupsService>(src => new GoodsGroupsService(
        src.GetRequiredService<ICategoriesRepository>()));
