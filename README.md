...
## [ShopServices](ShopServices) (In development) - pet project services for chain of shops (stores) (.NET 9.0, Microsoft EF Core, Dapper + PostgreSQL 17, MassTransit, RabbitMQ, Kafka).
