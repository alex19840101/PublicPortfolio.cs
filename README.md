# Public Portfolio (C#): ASP.NET Core (.NET 9.0) pet projects
...
## [ShopServices](ShopServices) (In development) - pet project microservices for chain of shops (stores) (.NET 9.0, Microsoft EF Core, Dapper + PostgreSQL 17, MassTransit, RabbitMQ, Kafka).
