...
namespace ProjectTasksTrackService.BusinessLogic.xTests
{
    public class ProjectsServiceTests
    {
        ...
        [Theory]
        [InlineData(20, "cd", null)]
        [InlineData(50, "cod", "nam")]
        [InlineData(30, null, "nam")]
        [InlineData(null, "cde", null)]
        [InlineData(null, "cod", "nam")]
        ...
        public async Task GetProject_ExistingProjectByCodeOrName_ShouldReturnProject(int? id, string codeSubStr, string nameSubStr)
        {
            ...
            Assert.NotNull(project);
            if (id != null) Assert.Equal(id, project.Id);
            Assert.Equal(existingProject, project);
        }

        [Theory]
        [InlineData(10, "cd", null)]
        [InlineData(60, "cod", "nam")]
        [InlineData(30, null, "nam")]
        [InlineData(null, "cde", null)]
        [InlineData(null, "cod", "nam")]
        [InlineData(null, null, "namE")]
        ...
        public async Task Update_CodeIsNullOrWhiteSpace_ShouldReturnUpdateResult_PROJECT_CODE_SHOULD_NOT_BE_EMPTY()
        {
            ...
            Assert.Equal(ErrorStrings.PROJECT_CODE_SHOULD_NOT_BE_EMPTY, updateResult.Message);
        }
        ...
        public async Task Update_NameIsNullOrWhiteSpace_ShouldReturnUpdateResult_PROJECT_NAME_SHOULD_NOT_BE_EMPTY()
        {
            ...
            Assert.NotNull(updateResult);
            Assert.Equal(System.Net.HttpStatusCode.BadRequest, updateResult.StatusCode);
            Assert.Equal(ErrorStrings.PROJECT_NAME_SHOULD_NOT_BE_EMPTY, updateResult.Message);
        }
        ...
        public async Task Update_ProjectIsValid_ShouldReturnUpdateResult_PROJECT_UPDATED()
        {
            ...
            Assert.Equal(Core.ErrorStrings.PROJECT_UPDATED, updateResult.Message);
        }
        ...
        public async Task Update_ProjectIsActual_ShouldReturnUpdateResult_PROJECT_IS_ACTUAL()
        {
            ...
            Assert.NotNull(updateResult);
            Assert.Equal(System.Net.HttpStatusCode.OK, updateResult.StatusCode);
            Assert.Equal(Core.ErrorStrings.PROJECT_IS_ACTUAL, updateResult.Message);
        }
        ...
        public async Task Update_ProjectNotFound_ShouldReturnUpdateResult_PROJECT_NOT_FOUND()
        {
            ...
            Assert.Equal(Core.ErrorStrings.PROJECT_NOT_FOUND, updateResult.Message);
        }
        ...
        public async Task Update_CodeChanging_ShouldReturnUpdateResult_CODE_SHOULD_BE_THE_SAME()
        {
            ...
            Assert.Equal(Core.ErrorStrings.CODE_SHOULD_BE_THE_SAME, updateResult.Message);
        }
