...
namespace ProjectTasksTrackService.BusinessLogic.MsTests
{
    ...
    public sealed class SubProjectsServiceTests
    {
        ...
        public async Task Create_SubDivisionIsNull_ShouldThrowArgumentNullException()
        {
            ...
            var exception = await Assert.ThrowsExactlyAsync<ArgumentNullException>(async () => createResult = await _subProjectsService.Create(sub));
        ...
        [TestMethod]
        public async Task Create_SubWithNotZerorId_ShouldReturnCreateResult_SUBPROJECT_ID_SHOULD_BE_ZERO_Fluent()
        {
            var sub = TestFixtures.TestFixtures.GetSubProjectFixtureWithAllFields(generateId: true);
            var createResult = await _subProjectsService.Create(sub);
        ...
        public async Task Import_SubsIsNull_ShouldThrowArgumentNullException()
        {
            ...
            var exception = await Assert.ThrowsExactlyAsync<ArgumentNullException>(async () => importResult = await _subProjectsService.Import(subs));
        ...
        public async Task Import_IMPORT_RESULT_STATUS_CODE_IS_NOT_OK_ShouldThrowInvalidOperationException()
        {
            ...
            ImportResult importResult = null;
            var exception = await Assert.ThrowsExactlyAsync<InvalidOperationException>(async () => importResult = await _subProjectsService.Import(subs));
