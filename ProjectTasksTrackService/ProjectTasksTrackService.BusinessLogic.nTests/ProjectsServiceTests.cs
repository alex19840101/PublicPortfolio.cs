...
namespace ProjectTasksTrackService.BusinessLogic.nTests
{
    public class ProjectsServiceTests
    {
        ...
        public async Task Update_CodeIsNullOrWhiteSpace_ShouldReturnUpdateResult_PROJECT_CODE_SHOULD_NOT_BE_EMPTY()
        {
            ...
            Assert.That(updateResult.Message, Is.EqualTo(ErrorStrings.PROJECT_CODE_SHOULD_NOT_BE_EMPTY));
        ...
        public async Task Update_NameIsNullOrWhiteSpace_ShouldReturnUpdateResult_PROJECT_NAME_SHOULD_NOT_BE_EMPTY()
        {
            ...
            Assert.That(updateResult != null);
            Assert.That(updateResult.Message, Is.EqualTo(ErrorStrings.PROJECT_NAME_SHOULD_NOT_BE_EMPTY));
            Assert.That(updateResult.StatusCode, Is.EqualTo(System.Net.HttpStatusCode.BadRequest));
        }
        ...
        public async Task Update_ProjectNotFound_ShouldReturnUpdateResult_PROJECT_NOT_FOUND()
        {
            ...
            Assert.That(updateResult != null);
            Assert.That(updateResult.Message, Is.EqualTo(Core.ErrorStrings.PROJECT_NOT_FOUND));
        ...
        public async Task Update_CodeChanging_ShouldReturnUpdateResult_CODE_SHOULD_BE_THE_SAME()
        {
            ...
            Assert.That(updateResult != null);
            Assert.That(updateResult.Message, Is.EqualTo(Core.ErrorStrings.CODE_SHOULD_BE_THE_SAME));
